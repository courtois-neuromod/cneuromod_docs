...
The anatomical dataset intends to acquire longitudinal anatomical image of the brain and upper spinal cord at an approximate rate of 4 sessions a year.
...
All images covering the face were anonymized by zeroing the data in the face, teeth and ears regions with a custom mask warped from the MNI space based on a linear registration of the T1w brain MRI series.
